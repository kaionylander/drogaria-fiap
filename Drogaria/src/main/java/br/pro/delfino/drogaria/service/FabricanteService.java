...
// http://127.0.0.1:7070/Drogaria/rest/fabricante
@Path("fabricante")
public class FabricanteService {
	...
	// http://127.0.0.1:7070/Drogaria/rest/fabricante/{codigo}
	// http://127.0.0.1:7070/Drogaria/rest/fabricante/10
	@GET
	@Path("{codigo}")
	...
	public String salvar(String json) {
		...
		int tamanho = fabricanteDAO.listar().size();

		Fabricante f = fabricanteDAO.listar().get(tamanho - 1);

		String saida = f.getDescricao();

		// String jsonSaida = gson.toJson(fabricante);
		return saida + " inserido com sucesso!";
	}
